        ...
        switch (what) {
            ...
            case 2:
                ...
                for (int i = 0; i < ja.size(); i++) {
                    ja.getJsonObject(i).put("room_name", new JsonObject(resultJO.getJsonArray("results").getJsonObject(i).getString("room_name"));
                    ja.getJsonObject(i).put("room_id", new JsonObject(resultJO.getJsonArray("results").getJsonObject(i).getString("room_id"));
                    ja.getJsonObject(i).put("is_private", new JsonObject(resultJO.getJsonArray("results").getJsonObject(i).getString("is_private"));
                }
